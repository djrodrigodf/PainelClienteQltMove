            ...
            <div class="col-md-12">
                <div class="nav-tabs-boxed">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        @endif
                        @if($proposta->status_id == 4 || $proposta->status_id == 5)
                            @if(count($vendas) >= 1)
                        ...
                        @if($proposta->status_id == 4 || $proposta->status_id == 5)
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#veiculo" role="tab" aria-controls="veiculo" aria-selected="false">Veiculo</a></li>
                        @endif
                    ...
                    <div class="tab-content">
                        ...
                        @if($proposta->status_id == 5 ||$proposta->status_id == 4)
                            <div class="tab-pane" id="veiculo" role="tabpanel">
                                @include('admin.propostas.tab_veiculo')
                            </div>
                        @endif
                    </div>
                </div>
