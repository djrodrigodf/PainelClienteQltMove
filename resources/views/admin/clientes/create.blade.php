    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clientes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_completo') ? 'is-invalid' : '' }}" type="text" name="nome_completo" id="nome_completo" value="{{ old('nome_completo', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel_resid') ? 'is-invalid' : '' }}" type="text" name="tel_resid" id="tel_resid" value="{{ old('tel_resid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel_celular') ? 'is-invalid' : '' }}" type="text" name="tel_celular" id="tel_celular" value="{{ old('tel_celular', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('prof_data_de_admissao') ? 'is-invalid' : '' }}" type="text" name="prof_data_de_admissao" id="prof_data_de_admissao" value="{{ old('prof_data_de_admissao') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('referenia_pessoals') ? 'is-invalid' : '' }}" name="referenia_pessoals[]" id="referenia_pessoals" multiple>
                    @foreach($referenia_pessoals as $id => $referenia_pessoal)
                        <option value="{{ $id }}" {{ in_array($id, old('referenia_pessoals', [])) ? 'selected' : '' }}>{{ $referenia_pessoal }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('referencia_bancaria') ? 'is-invalid' : '' }}" name="referencia_bancaria_id" id="referencia_bancaria_id">
                    @foreach($referencia_bancarias as $id => $referencia_bancaria)
                        <option value="{{ $id }}" {{ old('referencia_bancaria_id') == $id ? 'selected' : '' }}>{{ $referencia_bancaria }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="status_id">{{ trans('cruds.cliente.fields.status') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.cliente.fields.status_helper') }}</span>
            </div>
            <div class="form-group">
