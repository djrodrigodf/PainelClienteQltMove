        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control" name="ref_banco_codigo" id="ref_banco_codigo">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ref_agencia" id="ref_agencia" value="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="ref_conta">Conta</label>
                    <input class="form-control" type="text" name="ref_conta" id="ref_conta" value="">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ref_tempo_conta" id="ref_tempo_conta" value="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="ref_cartao_credito">Cartão de Crédito</label>
                    <input class="form-control" type="text" name="ref_cartao_credito" id="ref_cartao_credito" value="">
                </div>
            </div>
        </div>
    </div>
