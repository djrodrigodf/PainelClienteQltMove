...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.referenciaBancarium.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.referencia-bancaria.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="banco_codigo">{{ trans('cruds.referenciaBancarium.fields.banco_codigo') }}</label>
                <input class="form-control {{ $errors->has('banco_codigo') ? 'is-invalid' : '' }}" type="text" name="banco_codigo" id="banco_codigo" value="{{ old('banco_codigo', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agencia_codigo') ? 'is-invalid' : '' }}" type="text" name="agencia_codigo" id="agencia_codigo" value="{{ old('agencia_codigo', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tempo_de_conta') ? 'is-invalid' : '' }}" type="text" name="tempo_de_conta" id="tempo_de_conta" value="{{ old('tempo_de_conta', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cartao_de_credito') ? 'is-invalid' : '' }}" type="text" name="cartao_de_credito" id="cartao_de_credito" value="{{ old('cartao_de_credito', '') }}">
