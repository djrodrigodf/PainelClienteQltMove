...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.plano.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.planos.update", [$plano->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="marca">{{ trans('cruds.plano.fields.marca') }}</label>
                <input class="form-control {{ $errors->has('marca') ? 'is-invalid' : '' }}" type="text" name="marca" id="marca" value="{{ old('marca', $plano->marca) }}">
                @if($errors->has('marca'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ano') ? 'is-invalid' : '' }}" type="text" name="ano" id="ano" value="{{ old('ano', $plano->ano) }}">
                @if($errors->has('ano'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ano') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('veiculo') ? 'is-invalid' : '' }}" type="text" name="veiculo" id="veiculo" value="{{ old('veiculo', $plano->veiculo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('km') ? 'is-invalid' : '' }}" type="text" name="km" id="km" value="{{ old('km', $plano->km) }}">
                @if($errors->has('km'))
                    <div class="invalid-feedback">
                        {{ $errors->first('km') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('periodo') ? 'is-invalid' : '' }}" type="text" name="periodo" id="periodo" value="{{ old('periodo', $plano->periodo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_zero') ? 'is-invalid' : '' }}" type="number" name="r_zero" id="r_zero" value="{{ old('r_zero', $plano->r_zero) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_um') ? 'is-invalid' : '' }}" type="number" name="r_um" id="r_um" value="{{ old('r_um', $plano->r_um) }}" step="0.01">
                @if($errors->has('r_um'))
                    <div class="invalid-feedback">
                        {{ $errors->first('r_um') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_dois') ? 'is-invalid' : '' }}" type="number" name="r_dois" id="r_dois" value="{{ old('r_dois', $plano->r_dois) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_tres') ? 'is-invalid' : '' }}" type="number" name="r_tres" id="r_tres" value="{{ old('r_tres', $plano->r_tres) }}" step="0.01">
